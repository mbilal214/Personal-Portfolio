      ...
      <div className="flex flex-col items-center justify-center bg-gradient-to-r from-purple-400 to-blue-500 text-center p-8">
        <div className="w-full max-w-4xl mx-auto bg-white rounded-lg p-8 ">
          <div className="flex flex-col items-center">
            <Image src="/profile.jpg" alt="Your Name" width={140} height={140} className=" rounded-full border-4 border-blue-600 mb-4 " />
          ...
          <div className="mt-10">
            ...
            <div className="mt-4">
              ...
              <div className="bg-gray-100 p-6 rounded-lg shadow-md mb-8 hover:scale-105">
                <Image src="/22.jpg" alt="Cooking Website" width={800} height={800} className="  border border-black  rounded-lg mb-2" />
              ...
              {/* Project Card 2 */}
              <div className="bg-gray-100 p-6 rounded-lg shadow-md mb-8 hover:scale-105">
                <Image src="/33.jpg" alt="Resume Template" width={800} height={800} className=" border border-black rounded-lg mb-2" />
              ...
              <div className="bg-gray-100 p-6 rounded-lg mb-8">
                <Image src="/44.jpg" alt="Personal Portfolio" width={800} height={800} className="  border border-black rounded-lg mb-2 hover:scale-105" />
